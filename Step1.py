...
class PromptEvolution:
    ...
    def show_images(self, prompt_str, score, base_images, lora_images):
        fig, axes = plt.subplots(2, NUM_IMAGES_PER_EVAL, figsize=(15, 6))
        fig.suptitle(f"Prompt: {prompt_str} | Score: {score:.2f}", fontsize=12)
    ...
    def evaluate_prompt(self, prompt):
        ...
        try:
            ...
            self.show_images(prompt_str, score, base_images, lora_images)
    ...
    def run_evolution(self):
        ...
        try:
            for generation in range(MAX_GENERATIONS):
                ...
                scores = [self.evaluate_prompt(p) for p in self.population]
