...
class PromptEvolution:
    ...
    def show_images(self, prompt_str: str, score: float, base_images: list, lora_images: list, generation: int, output_dir: str = "results"):
    ...
    def evaluate_prompt(self, prompt, generation):
        ...
        try:
            ...
            for seed in SEEDS:
                ...
                elif IMAGE_MODEL == "stable-diffusion-v1-5":
